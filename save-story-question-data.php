...
if ( ! $auth_user->is_loggedin() ) {
	...
	if ( $_POST["question_id"] === "0" ) {
		if ( $story_list->add_story_question( $_POST["story_id"], $_POST["question"] ) ) {
			echo "<p>Story Question data Added</strong></p>";
		}
	} else if ( $story_list->update_story_question( $_POST["question_id"], $_POST["story_id"], $_POST["question"] ) ) {
