    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown messages-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
	        ...
	        <?php include_once "messages_drop_down.php" ?>
      </li>
      ...
      <li class="dropdown notifications-menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
	      ...
	      <?php include_once "notifications_drop_down.php" ?>
      </li>
      ...
      <li class="dropdown tasks-menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
	      ...
	      <?php include_once "tasks_drop_down.php" ?>
</li>
<!-- User Account: style can be found in dropdown.less -->
<li class="dropdown user user-menu">
<a href="#" class="dropdown-toggle" data-toggle="dropdown">
  <img src="<?php echo WEB_ROOT; ?>dist/img/user4-128x128.jpg" class="user-image" alt="User Image">
